...
import crud from "@/services/api/modules/icd10CRUD";
...
const {
  ...
  serverOptions,
  loadFromServer,
} = new IndexCRUD<App.Models.Administrasi.ICD10>({
  moduleName: "Icd10",
  crud,
  filterSchema: schema,
  headers: [
    { text: "ID", value: "id", sortable: true },
    { text: t("icd10.form.name_en"), value: "name_en", sortable: true },
    { text: t("icd10.form.name_locale"), value: "name_locale", sortable: true },
    { text: t("icd10.form.code"), value: "code", sortable: true },
    { text: "Aksi", value: "action", sortable: false },
  ],
  buttons: (index) => [
    {
      label: t("icd10.add-new-title"),
      iconClass: "plus",
      variant: "primary",
      outline: true,
      onClick: () => index.router.push({ name: "Icd10Create" }),
    },
  ],
})
