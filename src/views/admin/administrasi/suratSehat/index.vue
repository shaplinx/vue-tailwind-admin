<template>
  <div>
    <TableCard
      :title="t('suratSehat.index-title')"
      :useFilter="true"
...
import crud from "@/services/api/modules/SuratSehatCRUD";
...
const {
  ...
  headers: [
    ...
    {
      text: t("suratSehat.form.keperluan"),
      value: "keperluan",
      sortable: true,
    },
  ...
  buttons: (index) => [
    {
      label: t("suratSehat.add-new-title"),
      iconClass: "plus",
      variant: "primary",
      outline: true,
      onClick: () => index.router.push({ name: "SuratSehatForm" }),
    },
  ],
})
