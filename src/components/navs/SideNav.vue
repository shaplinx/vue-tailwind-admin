<template>
  <perfect-scrollbar>
    <div class="flex justify-center h-16 gap-4 items-center">
      <a aria-current="page" class="block active" href="/"><svg width="32" height="32" viewBox="0 0 32 32">
          <defs>
    ...
    <div class="flex justify-start" :class="compact ? 'rounded-3xl' : 'rounded-md'">
      <ul :class="compact ? 'gap-3 items-center' : 'rounded-md gap-3'" class="flex flex-col w-full list-none m-0 px-1">
